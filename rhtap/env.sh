...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap-test-organization-jk-private/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/t3pq1qwtz-java-springboot-gitops
